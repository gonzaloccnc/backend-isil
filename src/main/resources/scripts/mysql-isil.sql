...
/*
En la tabla users para el prfeosr se podria agregar speciality o una tabla para saber cual es la
specialities (id_speciality, id_career, name)
especialidad del profesor, en cursos agregar carrera
*/
